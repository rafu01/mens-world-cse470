...
public class CustomerController {
	...
	public RedirectView view_favorite(@PathVariable int id, Model model, Principal principal,
	...
	// private String ProcessSignup(@RequestParam("fullname") String fullname,
	...
	// e.printStackTrace();
	// model.addAttribute("customer",customer);
	// session.setAttribute("message",new Message(e.getMessage(),"notification
	// is-danger"));
	// return "signup";
	// }
	// }
	@PostMapping("/confirm-checkout")
	public String confirm_checkout(@RequestParam String name, @RequestParam String address, @RequestParam String number,
